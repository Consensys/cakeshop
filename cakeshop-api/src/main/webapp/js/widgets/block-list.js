...
module.exports = function() {
	var extended = {
		...
		templateRow: _.template('<tr><td>#<a href="#"><%= block.num %></a></td><td><%= block.age === 0 ? "Genesis" : moment(block.age).fromNow() %></td><td <% if (block.txnCount == 0) { %>style="opacity: 0.2;"<% } %>><%= block.txnCount %></td></tr>'),
